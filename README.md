...
It started as yet another _Entity-Component System (ECS)_ but grew more general and flexible soon.
...
During development several issues arose that were not addressed by existing ECS so far.
    ...
    class TomatoSauce : public PAX::Property<Pizza> {
        PAX_PROPERTY(Cheese, PAX_PROPERTY_IS_CONCRETE)
...
The pizza example is exemplified in detail in `examples/pizza`.
